...
SECRET_KEY = 'django-insecure-&^osyky=5c)#6^cg13b+h6pbt5si(mkhk-!p!nr6xj$2700wa2'

# SECURITY WARNING: don't run with debug turned on in production!
PRODUCTION = os.getenv("PRODUCTION", False)
DEBUG = not PRODUCTION

ALLOWED_HOSTS = ["localhost", "127.0.0.1", "irfan-rizqi31-mentalhealthtracker.pbp.cs.ui.ac.id", "10.0.2.2"]
